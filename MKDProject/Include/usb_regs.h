...
#define _ToggleDTOG_RX(bEpNum)    (_SetENDPOINT(bEpNum, \
                                   EP_DTOG_RX | (_GetENDPOINT(bEpNum) & EPREG_MASK)))//增加了括号加强等级区分
#define _ToggleDTOG_TX(bEpNum)    (_SetENDPOINT(bEpNum, \
                                   EP_DTOG_TX | (_GetENDPOINT(bEpNum) & EPREG_MASK)))//增加了括号加强等级区分
...
#define _SetEPAddress(bEpNum,bAddr) _SetENDPOINT(bEpNum,\
    (_GetENDPOINT(bEpNum) & EPREG_MASK) | bAddr)//增加了括号加强等级区分
