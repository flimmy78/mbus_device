...
const tLCD_APIList *GUI_GetRotate(int type);

#define GUI_ROTATION   tLCD_APIList
#define GUI_ROTATE_CCW GUI_GetRotate(0)//&LCD_APIListCCW
#define GUI_ROTATE_CW  GUI_GetRotate(1)//&LCD_APIListCW
#define GUI_ROTATE_180 GUI_GetRotate(2)//&LCD_APIList180
