...
**********************************************************************
*/
#define  WIDGET_EFFECT_3D			0
#define  WIDGET_EFFECT_3D1L			1
#define  WIDGET_EFFECT_3D2L			2
#define  WIDGET_EFFECT_NONE			3
#define  WIDGET_EFFECT_SIMPLE			4

const WIDGET_EFFECT *WIDGET_GetEffect(int type);
