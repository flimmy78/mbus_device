...
#define GUI_KEY_NUM5  		  0x35
#define GUI_KEY_NUM6  		  0x36
#define GUI_KEY_NUM7  		  0x37
#define GUI_KEY_NUM8 		  0x38
#define GUI_KEY_NUM9  		  0x39
#define GUI_KEY_BACKSPACE     0x08         /* ASCII: BACKSPACE Crtl-H */
#define GUI_KEY_TAB           0x15         /* ASCII: TAB       Crtl-I */
#define GUI_KEY_BACKTAB       0x09
#define GUI_KEY_ENTER         0x0D        /* ASCII: ENTER     Crtl-M */
#define GUI_KEY_LEFT          0x13
#define GUI_KEY_UP            0x11
#define GUI_KEY_RIGHT         0x14
#define GUI_KEY_DOWN          0x12
#define GUI_KEY_HOME          0x0B
#define GUI_KEY_END           0x0C
#define GUI_KEY_SHIFT         0x2D
#define GUI_KEY_CONTROL       0x2E
#define GUI_KEY_ESCAPE        0x1B        /* ASCII: ESCAPE    0x1b   */
#define GUI_KEY_INSERT        0x06
#define GUI_KEY_DELETE        0x10
#define GUI_KEY_SPACE         0x20
#define GUI_KEY_PGUP          0x1D
#define GUI_KEY_PGDOWN        0x1C
#define GUI_KEY_F0            0x01
#define GUI_KEY_F1            0x1E
#define GUI_KEY_F2            0x1F
#define GUI_KEY_Fn		  	  0x0A
...
#define GUI_ID_MENU0	  0x240
#define GUI_ID_MENU1	  0x241
#define GUI_ID_MENU2	  0x242
#define GUI_ID_MENU3	  0x243

#define GUI_ID_ITEM0	  0x300
#define GUI_ID_ITEM1	  0x301
#define GUI_ID_ITEM2	  0x302
#define GUI_ID_ITEM3	  0x303
#define GUI_ID_ITEM4	  0x304
#define GUI_ID_ITEM5	  0x305
#define GUI_ID_ITEM6	  0x306
#define GUI_ID_ITEM7	  0x307
#define GUI_ID_ITEM8	  0x308
#define GUI_ID_ITEM9	  0x309
#define GUI_ID_ITEM10	  0x310
#define GUI_ID_ITEM11	  0x311
#define GUI_ID_ITEM12	  0x312
#define GUI_ID_ITEM13	  0x313
#define GUI_ID_ITEM14	  0x314
#define GUI_ID_ITEM15	  0x315
#define GUI_ID_ITEM16	  0x316
#define GUI_ID_ITEM17	  0x317
#define GUI_ID_ITEM18	  0x318
#define GUI_ID_ITEM19	  0x319
#define GUI_ID_ITEM20	  0x320
#define GUI_ID_ITEM21	  0x321
#define GUI_ID_ITEM22	  0x322
#define GUI_ID_ITEM23	  0x323
#define GUI_ID_ITEM24	  0x324
#define GUI_ID_ITEM25	  0x325
#define GUI_ID_ITEM26	  0x326
#define GUI_ID_ITEM27	  0x327
#define GUI_ID_ITEM28	  0x328
#define GUI_ID_ITEM29	  0x329
...
int     GUI_MessageBoxYN (const char * sMessage, const char * sCaption, int Flags);
...
***************************************************************
*/
void _DrawBitmap(int x0, int y0, int xsize, int ysize, const U8 GUI_UNI_PTR * pPixel, const LCD_LOGPALETTE GUI_UNI_PTR * pLogPal, int xMag, int yMag) ;
void _DrawBitmapSwapRB(int x0, int y0, int xsize, int ysize, const U8 GUI_UNI_PTR * pPixel, const LCD_LOGPALETTE GUI_UNI_PTR * pLogPal, int xMag, int yMag);
...
#define GUI_DRAW_RLE4    0//&GUI_BitmapMethodsRLE4   /* Method table ! */
#define GUI_DRAW_RLE8    1//&GUI_BitmapMethodsRLE8   /* Method table ! */
#define GUI_DRAW_RLE16   2//&GUI_BitmapMethodsRLE16  /* Method table ! */
#define GUI_DRAW_RLEM16  3//&GUI_BitmapMethodsRLEM16 /* Method table ! */
#define GUI_DRAW_BMP555  4//&GUI_BitmapMethods555    /* Method table ! */
#define GUI_DRAW_BMPM555 5//&GUI_BitmapMethodsM555   /* Method table ! */
#define GUI_DRAW_BMP565  6//&GUI_BitmapMethods565    /* Method table ! */
#define GUI_DRAW_BMPM565 7//&GUI_BitmapMethodsM565   /* Method table ! */
#define GUI_DRAW_BMP888  8//&GUI_BitmapMethods888    /* Method table ! */
#define GUI_DRAW_BMPM888 9//&GUI_BitmapMethodsM888   /* Method table ! */
