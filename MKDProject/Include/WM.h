...
* with the WM_SYSTEM_MESSAGE message
*/

#define WM_TIMER_SECOND				1		//秒周期消息
#define WM_TIMER_MINUTE				2		//分钟周期信息
#define WM_TIMER_HOUR				3		//小时周期信息
#define WM_ALARM_POWER				4		//电压低报警
#define WM_ALARM_CLOCK				5		//闹钟报警
#define WM_ALARM_TEMP				6		//温度报警
#define WM_EVENT_USB_C				7		//USB接入
#define WM_EVENT_USB_D				8		//USB断开
#define WM_EVENT_CHARGE_P			9		//充电进行中
#define WM_EVENT_CHARGE_F			10		//充电结束
#define WM_EVENT_TF_IN				11		//TF卡插入
#define WM_EVENT_TF_OUT				12		//TF卡移除
